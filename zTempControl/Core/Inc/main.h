...
#define PUMPE_NORMAL_Pin GPIO_PIN_0
#define PUMPE_NORMAL_GPIO_Port GPIOB
#define LUEFTERS_Pin GPIO_PIN_1
#define LUEFTERS_GPIO_Port GPIOB
...
#define PUMPE_KRAFT_Pin GPIO_PIN_15
#define PUMPE_KRAFT_GPIO_Port GPIOA
